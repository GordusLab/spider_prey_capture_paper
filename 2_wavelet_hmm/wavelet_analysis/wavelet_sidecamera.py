...
def Wavelet_transform(fname, filename, dirOut, joints):
    #dirOut = 'C:/Users/Gordus_Lab/Desktop'
    ...
    np.savez( dirOut +'/wavelet/'+fname +s+'_nonormalized_wavelet.npz', amplitudes_x, amplitudes_y, f )
    ...
    fig.tight_layout()
    plt.savefig(dirOut +'/wavelet/'+fname +s+'_nonormalized_wavelet.png')
