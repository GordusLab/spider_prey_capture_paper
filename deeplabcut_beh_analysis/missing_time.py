...
directory = 'B:/HsinYi/DeepLabCut_Anthony/8videos_1400frames_relabled/videos/newvideo_piezo/aligned'
os.makedirs(os.path.join(directory, '/croprot/'), exist_ok=True)
files = glob.glob(directory+'/*.npy')

missing_file_csv = 'B:/HsinYi/DeepLabCut_Anthony/8videos_1400frames_relabled/videos/newvideo_piezo/aligned/missing_time.csv'
