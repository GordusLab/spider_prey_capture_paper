...
video_path = 'Z:\HsinYi\web_vibration/071024/101223 Spider Prey Pt1-10122023143036-0000.mp4'
...
def roi_frame(video_path):
    ...
    while True:
        ...
        if key == 27:  # Press 'Esc' key to exit
            ...
            np.savez(video_path.replace('.mp4', "_roi_coordinates_side.npz"), roi_spider_list=roi1_list,

                     roi_fly_list=roi2_list, nframes=nframes)
            print(len(roi1_list))
            print(len(roi2_list))
            break
        elif key == ord('s'):
