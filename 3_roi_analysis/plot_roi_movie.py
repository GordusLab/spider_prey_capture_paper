...
video_path = 'Z:\HsinYi\web_vibration/012122/012122_spider_prey/012122 Spider Prey.mp4.mp4'
stft =np.load(fname.replace( '.avi','_roi_stft.npz'))
...
cf = axs['TopRight'].pcolormesh(t, ff_stft[f_idx], f_spec_fly_p[f_idx], vmin=0, vmax=1000)
...
t = [i for i in range(int(400 / 2), (data.shape[2] - int(400 / 2)), 20)]
...
ln2 = axs['BottomRight'].axvline(200, color='green')
